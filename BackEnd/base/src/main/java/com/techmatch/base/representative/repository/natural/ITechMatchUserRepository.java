...
public interface ITechMatchUserRepository {

	
	/**
	 * ユーザの情報を更新する
	 */
	public void updateUserAllInfo(TechMatchUserAllInfoToUpdateModel userAllInfoToUpdateModel)throws TechMatchException;
